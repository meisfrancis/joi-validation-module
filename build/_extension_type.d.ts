declare namespace Joi {
    ...
    type BasicType = boolean | number | string | any[] | Record<string, any> | null;
    ...
    type SchemaLike = SchemaLikeWithoutArray | Record<string, any>;
    type SchemaMap<TSchema = any> = {
        [key in keyof TSchema]?: SchemaLike | SchemaLike[];
    };
    type Schema<P = any> = AnySchema | ArraySchema | AlternativesSchema | BinarySchema | BooleanSchema | DateSchema | FunctionSchema | NumberSchema | ObjectSchema<P> | StringSchema | LinkSchema | SymbolSchema;
    ...
    interface AnySchema extends SchemaInternals {
        ...
        /**
         * Group field with a given name. After grouping, the result of validation will have a key name "__group"
